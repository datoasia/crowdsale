...
interface Artifacts {
  require(name: './DATOToken.sol'): IContract<IDATOToken>;
  require(name: './DATOICO.sol'): IContract<IDATOICO>;
...
declare type TokenGroup = 'staff' | 'utility';
...
interface IBaseICOToken extends IBaseFixedERC20Token {
  ...
  // ICO/Pre-ICO smart contract allowed to distribute public funds for this DATOToken
...
/**
 * ERC20 DATO Token todo: url ?
 */
interface IDATOToken extends IBaseICOToken {
  // Token name
...
/**
 * DATO ICO smart contract.
 */
interface IDATOICO extends IBaseICO {
